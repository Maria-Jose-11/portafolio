    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- <img class="masthead-avatar mb-5" src="assets/img/profile_new.png" alt="..." /> -->
                <!-- Masthead Heading-->
                <!-- <h1 class="text-dark dark:text-white-200 font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6"> -->
                <h1 class="text-base font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6">
                Hola, soy Majo    
                <br/>
                <br/>
                <img src="https://cdn-icons-png.flaticon.com/512/64/64572.png" width="120px" height="100px" alt="perfil">
                <br/>
                ...
                Y soy desarrolladora de software.<br>
                </p> -->
                <!-- Icon Divider-->
                <ul class="flex flex-wrap items-center">
                    <button class="navbar-toggler text-uppercase font-weight-bold bg-primary text-white rounded">
                    <a href="#portfolio" class="navbar-toggler text-uppercase font-weight-bold bg-primary text-white">
                    <!-- <a href="#portfolio">Portfolio</a> -->Ver mis proyectos
                    </a>
                    </button>
                </ul>
            </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm"  action="https://formsubmit.co/maria.chala@epn.edu.ec" method="POST">
                            <!-- Name input-->
